...
function seccionDatosGenerales(data){
    ...
    let html='<tbody>\
                ...
                <tr>\
                    <td class="testarColor">' + testar(nodo.correoElectronico.institucional) + '</td>\
...
function seccionDomicilio(data){
    ...
    if(!data.declaracion.situacionPatrimonial.datosCurricularesDeclarante.ninguno){
        Object.keys(data.declaracion.situacionPatrimonial.datosCurricularesDeclarante.escolaridad).forEach(function (index) {
            ...
            html +='    <tr style="background-color: #dee2e6;">\
                            ...
                            <td style="width: 25%;">FECHA OBTENCIÓN</td>\
...
function seccionDatosEmpleoCargoComision(titulo, data){
    ...
    if (nodo.domicilio == "MX"){
        html='<tbody>\
                <tr><td colspan="3" style="background-color: #dee2e6; text-align: center;">DOMICILIO DEL DECLARANTE</td></tr>\
                <tr style="background-color: #dee2e6;">\
                    <td style="width: 33%;">CALLE</td>\
                    <td style="width: 33%;">NÚMERO EXTERIOR</td>\
                    <td style="width: 33%;">NÚMERO INTERIOR</td>\
...
function seccionDatosPareja(titulo, data){
    ...
    if(!data.declaracion.situacionPatrimonial.datosPareja.ninguno){
        ...
        if(data.declaracion.situacionPatrimonial.datosPareja.actividadLaboral.clave=="PUB"){
            ...
            html +='<tr style="background-color: #dee2e6;">\
                    ...
                    <tr>\
                        <td style="width: 34%;" class="testarColor">' + testar(actividadLaboralPareja.areaAdscripcion) + '</td>\
                        <td colspan="2" class="testarColor">' + testar(actividadLaboralPareja.funcionPrincipal) + '</td>\
                    </tr>';
        }
...
function seccionDatosDependienteEconomico(titulo, data){
    let html="";
...
function seccionIngresos(titulo, data){
    ...
    html +='<tr>\
            ...
            <tr>\
                ...
                <td style="text-align: right;" class="testarColor">' + testar(totalIngresosNetos + " " + totalIngresosNetosMoneda) + '</td>\
            </tr>';   
...
function seccionActividadAnualAnterior(titulo, data){
...
function seccionBienesInmuebles(titulo, data){
...
function seccionVehiculos(titulo, data){
    let html ='<tbody><tr><td colspan="3" style="background-color: #621132; color: #fff; font-size:14px;">' + titulo + '</td></tr>';
...
function seccionBienesMuebles(titulo, data){
    let html ='<tbody><tr><td colspan="3" style="background-color: #621132; color: #fff; font-size:14px;">' + titulo + '</td></tr>';
...
function seccionInversiones(titulo, data){
    let html="";
    html +='<tr><td colspan="3" style="background-color: #621132; color: #fff; font-size:14px;">' + titulo + '</td></tr>';
...
function seccionAdeudos(titulo, data){
    let html="";
    html +='<tr><td colspan="3" style="background-color: #621132; color: #fff; font-size:14px;">' + titulo + '</td></tr>';
...
function seccionPrestamoOComodato(titulo, data){
    let html="";
    html +='<tr><td colspan="3" style="background-color: #621132; color: #fff; font-size:14px;">' + titulo + '</td></tr>';
...
function seccionInteresesTitulo(){
    ...
    if(!data.declaracion.interes.participacion.ninguno){
        Object.keys(data.declaracion.interes.participacion.participacion).forEach(function (index) {
            ...
            if(nodo.tipoRelacion=="DECLARANTE" || nodo.tipoRelacion=="OTRO"){
                ...
                html+="</tr>";
                html+="<tr>";
                html+=" <td>" + testar(nodo.nombreEmpresaSociedadAsociacion) + "</td>";
                html+=" <td>" + testar(nodo.rfc) + "</td>";
                html+=" <td>" + testar(nodo.porcentajeParticipacion + "%") + "</td>";
                html+="</tr>";
                ...
                html+="</tr>";
                html+="<tr>";
                html+=" <td>" + testar(nodo.tipoParticipacion.valor) + "</td>";
                html+=" <td>" + testar(recibe) + "</td>";
                html+=" <td style='text-align: right;'>" + testar(format(nodo.montoMensual.valor) + nodo.montoMensual.moneda) + "</td>";
                html+="</tr>";
                ...
                html+="</tr>";
                html+="<tr>";
                html+=" <td>" + testar(nodo.ubicacion.pais) + "</td>";
                nodo.ubicacion.pais=="MX" ? html+=" <td>" + testar(nodo.ubicacion.entidadFederativa.valor) + "</td>": html+=" <td></td>";
                html+=" <td>" + testar(nodo.sector.valor) + "</td>";
                html+="</tr>";
            }
            html+="<tr><td colspan='3'><td></tr>"                                
        });
    ...
    if(!data.declaracion.interes.participacionTomaDecisiones.ninguno){
        Object.keys(data.declaracion.interes.participacionTomaDecisiones.participacion).forEach(function (index) {
            ...
            if(nodo.tipoRelacion=="DECLARANTE" || nodo.tipoRelacion=="OTRO"){
                ...
                html+="</tr>";
                html+="<tr>";
                html+=" <td>" + testar(nodo.puestoRol) + "</td>";
                html+=" <td>" + testar(nodo.fechaInicioParticipacion) + "</td>";
                html+="</tr>";
...
function seccionApoyos(data){
    ...
    if(!data.declaracion.interes.apoyos.ninguno){
        Object.keys(data.declaracion.interes.apoyos.apoyo).forEach(function (index) {
            ...
            else{ html+=" <td class='testarColor'>" + nodo.beneficiarioPrograma.valor + "</td>"; }
...
function seccionRepresentacion(data){
    let html="";
...
function seccionBeneficios(data){
    let html="";
